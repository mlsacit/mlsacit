      ...
      <div className="p-10 max-sm:p-3  ">
        ...
        <div className=" relative flex items-center flex-wrap justify-between gap-5  max-sm:flex-col">
          ...
          <div className="w-[38vw] ml-auto flex justify-center items-center max-sm:w-[100%] max-sm:p-[1vw]" data-aos="fade-left">
            ...
            MSA CIT is a chapter of the global Microsoft Learn Student Ambassador community at CIT Bengaluru. We empower learning through workshops and seminars, foster engagement through hands-on tech experiences, and cultivate leadership by driving innovation and industry exposure.
            </h3>
          </div>
        </div>
        ...
        <div className="mt-[5vw] flex max-sm:flex-col items-center w-full relative max-sm:p-[5vw]">
          ...
          <div className="w-full relative mt-auto max-sm:bg-gradient-to-br from-[#3a3a3a82] to-[#00000000] max-sm:rounded-tl-[23.69px] max-sm:rounded-bl-[23.69px] max-sm:ml-[4rem]">
            ...
            <h1 className="absolute inset-0 text-[1.5vw] font-semibold p-[2vw] text-white max-sm:p-[10vw] max-sm:text-[3vw]" data-aos="zoom-out">
              Founded in 2020, MSA CIT began with a single Alpha Microsoft Learn Student Ambassador, laying the foundation for a thriving tech-driven initiative.
            </h1>
          </div>
          ...
          <div className="w-full relative mb-auto max-sm:bg-gradient-to-r from-[#dcdcdc00] to-[#767676] max-sm:rounded-tr-[23.69px] max-sm:rounded-br-[23.69px] max-sm:mr-[4rem]">
            ...
            <h1 className="absolute inset-0 text-[1.5vw] font-semibold p-[2vw] max-sm:p-[10vw] max-sm:text-[3vw] text-black" data-aos="zoom-out">
              Now in its third generation of leaders, MSA CIT stands stronger than ever, successfully conducting impactful workshops and learning initiatives—driven by the commitment to push boundaries and shape the future of tech.
            </h1>
          </div>
          ...
          <div className="w-full relative mt-auto max-sm:bg-gradient-to-tr from-[#3a3a3acc] to-[#00000000] max-sm:rounded-tl-[23.69px] max-sm:rounded-bl-[23.69px] max-sm:ml-[4rem]">
            ...
            />
            <h1 className="absolute inset-0 text-[1.5vw] font-semibold p-[2vw] text-white max-sm:p-[10vw] max-sm:text-[3vw]" data-aos="zoom-out">
              What followed was a surge of innovation and learning, rapidly producing seven Beta MSAs and expanding the chapter into a dynamic and engaged network of tech enthusiasts.
            </h1>
          </div>
        </div>
...
//         >
//           <h3 className="text-[1.5vw] font-[Excon] text-white max-sm:text-[3vw]">
//             MSA CIT is a chapter of the global Microsoft Learn Student
...
//             data-aos="zoom-out"
//           >
//             Founded in 2020, MSA CIT began with a single Alpha Microsoft Learn
...
//             data-aos="zoom-out"
//           >
//             Now in its third generation of leaders, MSA CIT stands stronger
...
//             producing seven Beta MSAs and expanding the chapter into a dynamic
